...
(function () {
  ...
  function applyI18n() {
    ...
    // URL parametrini yangilash (b balka saqlash uchun)
    const newParams = new URLSearchParams(location.search);
    if (currentLang && currentLang !== newParams.get('lang')) {
  ...
  async function loadProfile() {
    ...
    try {
      ...
      // Bazadagi tilga qarab UI tilini yangilash
      if (p.lang && ['uz', 'ru', 'en'].includes(p.lang) && currentLang !== p.lang) {
        currentLang = p.lang;
        applyI18n();
      }
